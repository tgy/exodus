...
namespace Exodus.GUI.Items
{
    class ResourcesDisplayer : Item
    {
        ...
        public ResourcesDisplayer()
        {
            ...
            electrecity = new GUI.Components.Label(_font, "", _XBase, currentY + (t.Height - height) / 2, 41 * Data.GameDisplaying.Epsilon);
            electrecity.SetColor(255, 222, 0);
            Components.Add(electrecity);
            currentY += t.Height + _step;
            t = Textures.GameUI["Hydrogen"];
            Components.Add(new Components.JustTexture(t, _XBase + _step, currentY, 42 * Data.GameDisplaying.Epsilon));
            hydrogen = new GUI.Components.Label(_font, "", _XBase, currentY + (t.Height - height) / 2, 41 * Data.GameDisplaying.Epsilon);
            hydrogen.SetColor(109, 226, 255);
            Components.Add(hydrogen);
            currentY += t.Height + _step;
            t = Textures.GameUI["Iron"];
            Components.Add(new Components.JustTexture(t, _XBase + _step, currentY, 42 * Data.GameDisplaying.Epsilon));
            iron = new GUI.Components.Label(_font, "", _XBase, currentY + (t.Height - height) / 2, 41 * Data.GameDisplaying.Epsilon);
            iron.SetColor(183, 199, 206);
            Components.Add(iron);
            currentY += t.Height + _step;
            t = Textures.GameUI["Steel"];
            Components.Add(new Components.JustTexture(t, _XBase + _step, currentY, 42 * Data.GameDisplaying.Epsilon));
            steel = new GUI.Components.Label(_font, "", _XBase, currentY + (t.Height - height) / 2, 41 * Data.GameDisplaying.Epsilon);
            steel.SetColor(255, 255, 255);
            Components.Add(steel);
            currentY += t.Height + _step;
            t = Textures.GameUI["Graphene"];
            Components.Add(new Components.JustTexture(t, _XBase + _step, currentY, 42 * Data.GameDisplaying.Epsilon));
            graphene = new GUI.Components.Label(_font, "", _XBase, currentY + (t.Height - height) / 2, 41 * Data.GameDisplaying.Epsilon);
